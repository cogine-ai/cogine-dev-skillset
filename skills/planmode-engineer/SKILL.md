...
description: Use when reviewing an execution plan and you need engineering scrutiny across architecture, data flow, diagrams, edge cases, test coverage, and performance.
---
# planmode-engineer
