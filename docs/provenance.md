...
- `onsite-prototype-development` is Cogine-authored workflow guidance derived from internal onsite sales-prototyping discussions and anonymized validation runs. Its optional Refero routing points to separately available Refero skills or MCP capabilities and does not bundle Refero source, assets, or customer material. No customer meeting material, customer code, or generated prototype source is redistributed with the skill.
