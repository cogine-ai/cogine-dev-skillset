...
- `onsite-product-manager` is Cogine-authored workflow guidance derived from internal onsite product-discovery and sales-prototyping discussions. It does not bundle customer meeting material, customer assets, generated product directions, or prototype source.
- `onsite-product-design` is Cogine-authored workflow guidance derived from internal onsite design and sales-prototyping discussions. It may call separately available Refero skills or MCP capabilities but does not bundle Refero source, references, assets, customer material, or generated previews.
- `onsite-prototype-development` is Cogine-authored workflow guidance derived from internal onsite sales-prototyping discussions and anonymized validation runs. It consumes operator-confirmed product and design briefs and does not bundle third-party design sources, customer meeting material, customer code, or generated prototype source.
...
- `solus-product-master` is derived from a user-provided GPTs-era product-direction prompt and rewritten as a concise Cogine skill with separate reference material. It is archived under `archived/skills/` and no longer part of the installable public skillset.
...
- Review archived `solus-product-master` provenance if the original GPTs-era prompt has an identifiable external author or publication history.
