...
- `onsite-product-manager` is Cogine-authored workflow guidance derived from internal onsite product-discovery and sales-prototyping discussions. It does not bundle customer meeting material, customer assets, generated product documents, or prototype source.
