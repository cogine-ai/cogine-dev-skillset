...
- `onsite-prototype-development` is Cogine-authored workflow guidance derived from internal onsite sales-prototyping discussions and anonymized validation runs. No customer meeting material, customer code, or generated prototype source is redistributed with the skill.
