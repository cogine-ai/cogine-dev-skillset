...
- `goal-contract` is locally authored Cogine workflow guidance for converting a dev plan into a runtime-enforceable goal description before goal-mode execution.
